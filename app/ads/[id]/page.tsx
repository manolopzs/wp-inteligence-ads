...
const HOOK_COLORS: Record<string, string> = { fomo: 'orange', exclusivity: 'rose', urgency: 'red', social_proof: 'blue', benefit: 'green', curiosity: 'orange' }
const ANGLE_COLORS: Record<string, string> = { matter_of_fact: 'zinc', aspirational: 'pink', fear_of_missing_out: 'orange', insider_access: 'rose', time_saving: 'blue', status: 'rose' }
